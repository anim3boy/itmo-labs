...
В проекте используются некоторые спорные архитектурые решения связанные с типизацией из-за использования самописного парсера JSON. При модификации проекта в ходе разработки заданий к следующим лабораторным работам планирую перейти на Jackson Framework.
